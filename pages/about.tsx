    ...
    <Layout title="About">
      <div className="container mx-auto md:px-24 flex px-5 py-12 md:flex-row flex-col items-center text-dark dark:text-white">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed text-justify font-sans">
            ...
            world. Our motto,{" "}
            <span className="font-sanssm">
              "Curiosity is the key to Creativity"
            </span>{" "}
            speaks volumes about our objective and love for technology.
          </p>
        </div>
      ...
      <div className="container mx-auto md:px-24 flex px-5 py-12 flex-col items-center">
        {about.map((item, index) => (
          <div
            className="border-2 border-black dark:border-gray-400 mb-4 rounded-md w-full"
            key={index}
          >
            <div className="container mx-auto md:px-24 flex px-5 py-12 md:flex-row flex-col items-center">
              <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                ...
                <h1 className=" sm:text-xl text-lg mb-4 font-medium text-gray-700 dark:text-gray-300 dark:text-grey">
                  {item.role}
                </h1>
              </div>
              <div className="w-72">
